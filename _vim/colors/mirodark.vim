...
call s:HI(          "Pmenu", s:dwht, s:dgrn,        "" )
call s:HI(       "PmenuSel", s:dwht, s:dred, "reverse" )
call s:HI(         "Visual", s:lwht, s:lblk,        "" )
call s:HI(     "StatusLine", s:dwht, s:dblk,        "" )
call s:HI(   "StatusLineNC", s:dwht, s:lblk,        "" )
call s:HI(      "VertSplit", s:dblk, s:dblk,        "" )
call s:HI(     "CursorLine", s:dblk, s:lred,    "none" )
" )
" }}}
